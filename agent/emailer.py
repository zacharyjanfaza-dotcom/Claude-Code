...
def build_html(analysis: dict) -> str:
    ...
    scraper_status = analysis.get("_scraper_status", {})
    scraper_footer = ""
    if scraper_status:
        lines = " &nbsp;|&nbsp; ".join(f"{k}: {v}" for k, v in scraper_status.items())
        scraper_footer = f"<br>Sources: {lines}"
      ...
      <table width="640" cellpadding="0" cellspacing="0"
        ...
        <tr>
          <td style="padding:32px 36px;">
            ...
            <p style="margin-top:40px;font-size:0.75rem;color:#aaa;border-top:1px solid #e8e8e8;
